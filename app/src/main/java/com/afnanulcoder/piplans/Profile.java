...
public class Profile extends AppCompatActivity {
    ...
    public void ShowPersonalProjectsAndProblems()
    {
        ...
        customAdapterForProject = new CustomAdapterForProject(Profile.this, projectList);
        customAdapterForProblem = new CustomAdapterForProblem(Profile.this, problemList);
        ...
        databaseReference1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren())
                {
                    ...
                    if(projectDetails.getUploaderName().equals(fullName))
                    {
        ...
        databaseReference2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren())
                {
                    ...
                    if(problemDetails.getSubmitterName().equals(fullName))
                    {
        ...
        projectsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Profile.this, ProjectsDetailsView.class);
        ...
        problemsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Profile.this, ProblemsDetailsView.class);
